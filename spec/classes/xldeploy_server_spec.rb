...
describe 'xldeploy::server' do
  ...
  shared_examples 'a Linux Os' do
    ...
    context 'xldeploy with version set to 3.9.4' do
      ...
      it { should contain_ini_setting('xldeploy.admin.password').with({:ensure=>'present',:path=>'/opt/deployit/deployit-server/conf/deployit.conf',:section=>'',:setting=>'admin.password',:value=>'xebialabs'})}
