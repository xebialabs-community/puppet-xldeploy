...
class xldeploy::install (
  ...
  $tmp_dir                     = $xldeploy::tmp_dir,
  $os_user                     = $xldeploy::os_user,
  $os_group                    = $xldeploy::os_group,
  $install_type                = $xldeploy::install_type,
  $server_home_dir             = $xldeploy::server_home_dir,
  $cli_home_dir                = $xldeploy::cli_home_dir,
  $install_java                = $xldeploy::install_java,
  $java_home                   = $xldeploy::java_home,
  $puppetfiles_xldeploy_source = $xldeploy::puppetfiles_xldeploy_source,
  $download_user               = $xldeploy::download_user,
  $download_password           = $xldeploy::download_password,
  $download_proxy_url          = $xldeploy::download_proxy_url,
  $download_server_url         = $xldeploy::download_server_url,
